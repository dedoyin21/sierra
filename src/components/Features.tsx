  ...
  return (
    <section id="features" className="w-full bg-white px-4 py-12 md:py-32 font-Manrope">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Cards Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-4 md:px-14 md:pb-14">
          {cards.map((card) => (
            <div
              key={card.id}
              className="group relative overflow-hidden rounded-xl h-124 sm:h-72 lg:h-102"
            >
              <img
